                ...
                <div class="col-md-12">
                  <p>
                    ...
                    <?php if (array_key_exists($question['eq_id'],$quest_id)) { ?> 
                      ...
                      <a data-toggle="modal" data-target="#loadFeedTextAnsModal" onclick="loadFeedTextAns('<?php echo $question['eq_id'] ?>','<?php echo $question['eq_templ_id'] ?>')" href="#"><?= count($quest_id[$question['eq_id']]); ?> Answers</a>
