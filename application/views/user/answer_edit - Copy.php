              ...
              <div class="box-body" id="">
                <?php $i=1; foreach($questions as $question){ ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="qstn_text<?php echo $question['eq_id'] ?>" value="<?php echo $question['qa_text_ans'] ?>" required="" autocomplete="off">
                    <?php } else { 
                      ...
                      foreach($options as $option){ 
                        ...
                        if($question['eq_answer_type']=='radio'){ ?>
                          <div class="radio">
                            <label>
                              <input type="radio" name="qstn_radio<?php echo $question['eq_id'] ?>" required="" value="<?php echo $option['eqo_id'] ?>" <?php if($option['eqo_id'] == $question['qa_option_id']) { echo 'checked'; }?>><?php echo $option['eqo_option'] ?>
                            </label>
                          </div>
                      ...
                      <?php } else { ?>
                          ...
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" class="req_question" name="qstn_check<?php echo $question['eq_id'] ?>[]" value="<?php echo $option['eqo_id'] ?>" <?php if(in_array($option['eqo_id'], explode(',', $question['qa_option_id']))) { echo 'checked'; }?>><?php echo $option['eqo_option'] ?>
                            </label>
                          </div>
